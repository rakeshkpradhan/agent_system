# Create Agent 1: Evidence Summarizer Agent
agent1_code = '''"""
...
with open("agentic_compliance_system/agents/evidence_summarizer_agent.py", "w") as f:
    f.write(agent1_code)

print("✅ Created Agent 1: Evidence Summarizer Agent")