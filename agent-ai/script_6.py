# Create Agent 2: Control Retrieval Agent
agent2_code = '''"""
...
with open("agentic_compliance_system/agents/control_retrieval_agent.py", "w") as f:
    f.write(agent2_code)

print("✅ Created Agent 2: Control Retrieval Agent")