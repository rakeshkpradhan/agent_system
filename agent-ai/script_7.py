# Create Agent 3: Policy Evaluation Agent
agent3_code = '''"""
...
with open("agentic_compliance_system/agents/policy_evaluation_agent.py", "w") as f:
    f.write(agent3_code)

print("✅ Created Agent 3: Policy Evaluation Agent")